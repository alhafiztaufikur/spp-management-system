...
<?php if($template==='titipan-spp'): ?><div class="field-row"><label class="field-label">Tanggal Awal</label><input class="field-input" type="date" name="tanggal_awal" value="<?= report_e($filters['tanggal_awal']) ?>"></div><div class="field-row"><label class="field-label">Tanggal Akhir</label><input class="field-input" type="date" name="tanggal_akhir" value="<?= report_e($filters['tanggal_akhir']) ?>"></div><div class="field-row"><label class="field-label">Operator</label><select class="field-input field-select" name="operator"><option value=""><?= report_e($operatorFilterLabel) ?></option><?php foreach($operatorOptions as $operator): ?><option value="<?= (int)$operator['id'] ?>" <?= $filters['operator']==(string)$operator['id']?'selected':'' ?>><?= report_e($operator['nama']) ?></option><?php endforeach; ?></select></div><?php endif; ?>
