...
Gunakan [repair_one_time_fees.sql](../sql/repair_one_time_fees.sql) untuk database lama yang sudah memakai struktur Pangkal/PSB saat ini dan harus dipertahankan datanya.
...
Untuk mengganti seluruh data demo dengan baseline terbaru, gunakan [panduan reset baseline demo](DEMO_DATA_RESET.md), bukan skrip ini. Seeder demo lama yang memakai struktur tagihan terdahulu telah dihapus.
