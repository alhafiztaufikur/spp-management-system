...
Koreksi bukti regression umum: `REG-FINAL-006` mengulang suite disposable lengkap pada HEAD saat ini dan lulus 18/18 setelah sinkronisasi username sesi; referensi `REG-FINAL-003`/`004`/`005` di bagian historis tetap dipertahankan untuk jejak audit.
