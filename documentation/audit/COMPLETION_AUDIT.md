...
Koreksi evidence terbaru: regression disposable diulang sebagai `REG-FINAL-009` dan lulus 18/18 pada clone `db_spp_audit_20260827_040945_suite_5871` setelah password fixture test dibuat acak; concurrency retest `CONC-004` lulus 25/25. Ringkasan tersanitasi disimpan di luar repository; referensi run sebelumnya tetap dipertahankan sebagai histori.
...
| 3 | Manifest aplikasi | `APPLICATION_MANIFEST.md` (63 PHP terlihat, 25 SQL, 8 asset; 29 route produksi; runtime evidence source commit `2c88ab0`, dokumentasi audit menyusul) | PARSIAL | Commit sudah tercatat, tetapi tag/package allowlist final dan graph pemanggilan fungsi/selector runtime belum memiliki coverage penuh |
